...
class Location:
    ...
    Instance Attributes:
        - id_num: The unique ID of the location.
        - brief_description: A short description of the location.
        - long_description: A detailed description of the location.
        - available_commands: A dictionary mapping commands to destination location IDs.
        - items: A list of items available at the location.
        - visited: Whether the location has been visited before.
